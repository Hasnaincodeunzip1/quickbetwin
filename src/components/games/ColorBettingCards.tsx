        ...
        return (
          ...
          >
            <button
              ...
              className={`relative w-full h-28 rounded-2xl overflow-hidden touch-manipulation select-none
            ...
            >
              ...
              {/* Content */}
              <div className="relative h-full flex flex-col items-center justify-center text-white pointer-events-none">
              ...
              {/* Decorative elements */}
              <div className="absolute -right-4 -bottom-4 w-20 h-20 bg-white/10 rounded-full blur-2xl pointer-events-none" />
              <div className="absolute -left-4 -top-4 w-16 h-16 bg-white/10 rounded-full blur-xl pointer-events-none" />
            </button>
            
            {/* Bet placed indicator - outside button to avoid click interference */}
            {hasBet && (
              <motion.div 
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                className="absolute -top-2 -right-2 min-w-[40px] h-10 bg-white rounded-full flex items-center justify-center shadow-lg px-2 pointer-events-none z-10"
              >
